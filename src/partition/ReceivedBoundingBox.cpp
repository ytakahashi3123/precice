...
void ReceivedBoundingBox::communicatePartition()
{
  ...
  _m2n->receiveMesh(*_mesh);
}

void ReceivedBoundingBox::computePartition()
{  
  ...
  // (6) Compute distribution and local communication map
